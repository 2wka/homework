my_string = input('Введите ваш текст: ') # Создайте переменную my_string и присвойте ей значение строки с произвольным текстом (функция input())
print('Длина вашего текста:', len(my_string)) # Выведите на экран длину строки
...
print(my_string[1])# Выведите первый символ строки my_string
